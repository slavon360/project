...
class Faq extends Component{
    ...
    selectSection = (section) => {
      let updSections = [...this.state.sections], updSelectedSection;
      updSections = updSections.map((sect) => {
        sect.checked = sect.title === section.title ? true : false;
    ...
    showAnswer = (qst) => {
      let updQuestions = [...this.state.selectedSection.questions], updSelectedSection = {...this.state.selectedSection};
      updQuestions = updQuestions.map((question) => {
        question.checked = question.questionTitle === qst.questionTitle && !question.checked ? true : false;
        return question;
      });
    ...
    render(){
      let questions = this.state.selectedSection ? this.state.selectedSection.questions : null;
      return(
