        ...
        return (
          <div key={coin.name} className={classes.CoinWrp}>
            <Button
              ...
              <img src={require(`../../assets/images/icons/${coin.name}.png`)}/>
              <span>{coin.name}</span>
              <div className={classes.Checked}><img src={require('../../assets/images/icons/checked.png')}/></div>
            </Button>
          </div>
        )
    })
          ...
          <form className={classes.BuySellForm}>
            ...
            <div className={classes.InputsWrp}>
              ...
              <Button
                ...
                type="button">
                <img src={require(`../../assets/images/icons/switch.png`)} />
              </Button>
              <Input
