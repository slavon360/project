...
const bankAccount = props => (
  <div className={classes.BankAccountWrp}>
    ...
    <div className={classes.InputsContent}>
      <Input
        elementConfig={{ placeholder: 'Account Name' }}
        wrpClasses={['BankAccountName']}
        value={props.bankAccount.accountName}
      />
      <Input
        elementConfig={{ placeholder: 'BSB' }}
        wrpClasses={['BSB']}
        value={props.bankAccount.bsb}
      />
      <Input
        elementConfig={{ placeholder: 'Account Number' }}
        wrpClasses={['BankAccountNumber']}
        value={props.bankAccount.accountNumber}
      />
      <Input
        elementConfig={{ placeholder: 'Account Nickname' }}
        wrpClasses={['BankAccountNickname']}
