...
import InputsBlockWithdrawDollar2 from '../../InputsBlock/InputsBlockWithdrawDollar-2';
import classes from './WithdrawDollar-2.css';
...
const depositWithdraw = props => (
  <div className={classes.DepositWithdrawWrp}>
    ...
    <InputsBlockWithdrawDollar2
      bank={props.bank}
      showBanksDpDwn={props.showBanksDpDwn}
      hideBanksDropdown={props.hideBanksDropdown}
      hideShowBanksDropdown={props.hideShowBanksDropdown}
    />
  </div>
);
